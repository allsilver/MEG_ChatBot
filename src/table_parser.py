...
def transform_table_to_markdown():
    ...
    # ├── data/
    # │   └── result/
    # │       ├── preprocessed_data_final.xlsx  ← 입력
    # │       └── final_text_data_*.xlsx        ← 출력
    # └── src/
    #     └── table_parser.py  ← 현재 파일
    ...
    # Reason 항목을 제외하고 프롬프트 구성
    # (나중에 Reason 행이 채워지면 raw_reason = str(row['Reason']).strip() 추가 후 프롬프트에 포함)
    template = """
